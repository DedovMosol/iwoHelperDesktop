...
namespace ExcelMerger
{
    ...
    /// компоненты из одной линии, не ставшие таблицей (прочерки полей «______ №»;
    ...
    internal static class TableDetector
    {
        ...
        /// <summary>
        /// Компонент из смыкающихся кусков ОДНОЙ горизонтальной оси (линия-заполнитель поля рисуется
