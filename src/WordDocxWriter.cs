...
namespace ExcelMerger
{
    ...
    public static class WordDocxWriter
    {
        ...
        /// PDF (pt), с защитой пределов. Горизонтально центрированное на странице изображение (логотип,
        ...
        // ширины) и почти равны (разница <= этой доли) — логотип/логотип сверху по центру. Иначе левый
