...
namespace ExcelMerger
{
    ...
    public abstract class PdfToolFormBase : Form, IBusyAware
    {
        ...
        /// <summary>
        /// Открыть «Прочие операции» с готовым документом. Ставит стартовый экран — он знает
        /// все инструменты и служит их композиционным корнем, поэтому инструменты не заводят
        /// ссылок друг на друга.
        ///
        /// Мост есть там, где инструмент может НАЗВАТЬ свой PDF: у «Разделения» это открытый
        /// документ, у «Объединения» — только что собранный файл. У «PDF → Word» такого файла
        /// нет вовсе (источников много, а результат — .docx), поэтому моста там нет.
        /// В смоук-тестах и самопроверке моста тоже нет — инструменты это учитывают.
        /// </summary>
        protected Action<string> OpsBridge { get; set; }
