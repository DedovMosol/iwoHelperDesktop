...
namespace ExcelMerger
{
    ...
    internal static class Loc
    {
        ...
        private static Dictionary<string, string[]> Build()
        {
            ...
            // Флажок пропускает эту версию, но не глушит проверку навсегда: следующий
            // выпуск снова напомнит, даже если про этот просили не спрашивать.
            ...
            A("grid.menu.insertBlank", "Вставить пустую страницу", "Insert a blank page");
            A("ops.blankPage.name", "пустая страница", "blank page");
            A("common.print.preview", "Предпросмотр печати", "Print preview");
            A("common.print.doPrint", "Печать", "Print");
            // Показаны не все листы (см. PrintPreviewForm): молчать об этом нельзя, иначе
            // неполный предпросмотр читается как «в задании всего столько страниц».
            A("common.print.previewPart", "Показаны первые {0} из {1} страниц",
                "Showing the first {0} of {1} pages");
