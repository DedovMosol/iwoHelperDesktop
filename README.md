...
[![Installer x64](https://img.shields.io/badge/Installer-x64-0F6CBD?style=for-the-badge&logo=windows&logoColor=white)](https://github.com/DedovMosol/iwoHelperDesktop/releases/latest/download/iwoHelperDesktop-setup.exe) [![Portable x64](https://img.shields.io/badge/Portable-x64-107C41?style=for-the-badge&logo=windows&logoColor=white)](https://github.com/DedovMosol/iwoHelperDesktop/releases/latest/download/iwoHelperDesktop.exe) [![Installer x86](https://img.shields.io/badge/Installer-x86-0F6CBD?style=for-the-badge&logo=windows&logoColor=white)](https://github.com/DedovMosol/iwoHelperDesktop/releases/latest/download/iwoHelperDesktop-setup-x86.exe) [![Portable x86](https://img.shields.io/badge/Portable-x86-107C41?style=for-the-badge&logo=windows&logoColor=white)](https://github.com/DedovMosol/iwoHelperDesktop/releases/latest/download/iwoHelperDesktop-x86.exe)
...
| Windows | Download |
|----|----------|
| **64‑bit** — Windows 8.1 / 10 / 11 *(most PCs)* | [![Installer](https://img.shields.io/badge/Installer-x64-0F6CBD?logo=windows&logoColor=white)](https://github.com/DedovMosol/iwoHelperDesktop/releases/latest/download/iwoHelperDesktop-setup.exe) &nbsp; [![Portable](https://img.shields.io/badge/Portable-x64-107C41?logo=windows&logoColor=white)](https://github.com/DedovMosol/iwoHelperDesktop/releases/latest/download/iwoHelperDesktop.exe) |
| **32‑bit** — 32‑bit editions of Windows 8.1 / 10 | [![Installer](https://img.shields.io/badge/Installer-x86-0F6CBD?logo=windows&logoColor=white)](https://github.com/DedovMosol/iwoHelperDesktop/releases/latest/download/iwoHelperDesktop-setup-x86.exe) &nbsp; [![Portable](https://img.shields.io/badge/Portable-x86-107C41?logo=windows&logoColor=white)](https://github.com/DedovMosol/iwoHelperDesktop/releases/latest/download/iwoHelperDesktop-x86.exe) |

*The buttons download the **latest** build directly (stable asset names). The full list of files is on the [releases page](https://github.com/DedovMosol/iwoHelperDesktop/releases/latest).*
