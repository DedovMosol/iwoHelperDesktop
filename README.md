...
- **PDF → Word** — add one or several born‑digital PDFs (button or drag‑and‑drop), reorder or drop pages across all of them on the thumbnail grid if needed, then **Convert to Word…** and choose the `.docx` name — they merge into one document.
