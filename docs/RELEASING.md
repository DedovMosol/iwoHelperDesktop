...
download pinned to the release. **Update those four URLs (and the version note) in the
README when you bump the version**, so the buttons point at the new files.
